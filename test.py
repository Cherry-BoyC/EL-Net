...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'G:\EL-Net\EL-Net\weights\best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='G:/EL-Net/data/Vis.yaml', help='*.data path')
