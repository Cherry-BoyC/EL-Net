...
from models.SEatt import SEAttention
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 ...
                 Bottleneck, BottleneckCSPA, GSConvns, BottleneckCSPB, BottleneckCSPC,
                 RepBottleneck, RepBottleneckCSPA, RepBottleneckCSPB, RepBottleneckCSPC,  
                 Res, ResCSPA, ResCSPB, ResCSPC, RepRes, RepResCSPA, RepResCSPB, RepResCSPC, ResX, ResXCSPA, ResXCSPB, VoVGSCSPC, ResXCSPC, RepResX, RepResXCSPA, RepResXCSPB, RepResXCSPC, Ghost, GhostCSPA, GhostCSPB, RFEM, GhostCSPC, SwinTransformerBlock, STCSPA, STCSPB, STCSPC,SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC, Yolov7_Tiny_E_ELAN, Yolov7_Tiny_SPP, Yolov7_E_ELAN, Yolov7_E_ELAN_NECK, Yolov7x_E_ELAN, Yolov7_Tiny_E_ELAN_Attention, Yolov7_Tiny_E_ELAN_DCN, Yolov7_Tiny_E_ELAN_DBB, DiverseBranchBlock, VoVGSCSP, GSConv, Yolov7_Tiny_E_ELAN_Ghost, GhostCSPC, GhostConv, DSConv2D]:
            c1, c2 = ch[f], args[0]
            ...
            c2 = m.feature_info.channels()
                   ...
                   fasternet_t0, fasternet_t1, fasternet_t2, fasternet_s, fasternet_m, fasternet_l, EMO_1M, EMO_2M, EMO_5M}:
            m = m(*args)
            c2 = m.channel
        elif m is EVCBlock:
            c2 = ch[f]
