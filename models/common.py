...
from models.SimATT import SimAM
...
class Yolov7_Tiny_E_ELAN_LSKBlock(nn.Module):
    def __init__(self, inc, ouc, hidc, act=True):
        super(Yolov7_Tiny_E_ELAN_LSKBlock, self).__init__()
...
class Yolov7_Tiny_E_ELAN_Ghost(nn.Module):
    def __init__(self, inc, ouc, hidc, act=True):
        super(Yolov7_Tiny_E_ELAN_Ghost, self).__init__()

        self.conv1 = Conv(inc, hidc, k=1, act=act)
        self.conv2 = Conv(inc, hidc, k=1, act=act)
        self.conv3 = GhostConv(hidc, hidc, k=3, act=act)
        self.conv4 = GhostConv(hidc, hidc, k=3, act=act)
        self.conv5 = Conv(hidc * 4, ouc, k=1, act=act)
...
class Yolov7_Tiny_SPP_LSKblock(nn.Module):
    def __init__(self, inc, ouc, act=True):
        super(Yolov7_Tiny_SPP_LSKblock, self).__init__()
...
class Yolov7_Tiny_E_ELAN_DBB_LSKBlock(nn.Module):
    def __init__(self, inc, ouc, hidc, act=True):
        super(Yolov7_Tiny_E_ELAN_DBB_LSKBlock, self).__init__()
...
class CARAFE(nn.Module):
    def __init__(self, c, k_enc=3, k_up=5, c_mid=64, scale=2):
        ...
        self.comp = Conv(c, c_mid, act=nn.LeakyReLU())
